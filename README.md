> [!CAUTION]
> In this module the servers are created based on the user's email and not using the id in whmcs, to avoid problems of giving the server to the wrong people.
